...
# shellcheck disable=SC2034  # Uncomment/adjust any shellcheck exceptions as needed

echo "Installing Aider"

# 1. Ensure Python3 and pip are present
...
# 4. Mark repo as safe if using Aider inside container
...
# Copy init-firewall.sh to /usr/local/bin
